...
exports.match = function(r1, g1, b1) {
  ...
  // The above will return true for empty cache because weird JS bug
  // hence checking against undefined
  if (exports._cache[hash] !== undefined) {
...
exports.convert = function(color) {
  if (typeof color === 'string') {
    ...
    // Color hex values are not identified
